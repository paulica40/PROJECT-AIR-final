    ...
    return (
      <div
        className={[
          ...
          'sing-dashboard',
          `dashboard-${(localStorage.getItem("sidebarType") === SidebarTypes.TRANSPARENT) ? "light" : (localStorage.getItem("dashboardTheme") || "fourth")}`,
          ...
          <Hammer onSwipe={this.handleSwipe}>
            ...
            <BreadcrumbHistory url={this.props.location.pathname} />
              ...
              <footer className={s.contentFooter}>
                AIR - Made by <a href="https://flatlogic.com" target="_blank">Flatlogic</a>
              </footer>
            </main>
          </Hammer>
        </div>
